...
module.exports = function (options) {
    return through.obj(function (file, enc, cb) {
        ...
        html = html.replace(/url\("?([^\)"]+)"?\)/g, function (str, url) {
            ...
            //options.customDate 自定义时间
            if (options.customDate) {
                return "url(" + url + "?_v=" + options.customDate + ")";
            } else if (options.useDate) {
                return "url(" + url + "?_v=" + formatDate(format, new Date()) + ")";
            }
        ...
        if (options.useDate && options.customDate) {
